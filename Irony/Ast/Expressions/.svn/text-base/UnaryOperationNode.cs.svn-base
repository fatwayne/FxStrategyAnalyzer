...
namespace Irony.Ast {
  ...
  public class UnaryOperationNode : AstNode {
    ...
    private void EvaluateMinus(EvaluationContext context, AstMode mode, DateTime time)
    {
    ...
    private void EvaluateNot(EvaluationContext context, AstMode mode, DateTime time)
    {
      Argument.Evaluate(context, AstMode.Read, time);
