...
namespace StrategyAnalyzerTest
{
    ...
    /// <summary>
    ///This is a test class for StrategyFormulizerTest and is intended
    ///to contain all StrategyFormulizerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class StrategyFormulizerTest
    {
        ...
        /// <summary>
        ///A test for StrategyFormulizer Constructor
        ///</summary>
        [TestMethod()]
